...
./run.sh $SIMULTANEOUS $NUMBER com.hortonworks.streaming.impl.domain.wellsfargo.Securities com.hortonworks.streaming.impl.collectors.KafkaCollector > /dev/null &
done
wait
echo "done"
